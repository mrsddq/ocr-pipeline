...
class PortfolioContractTests(unittest.TestCase):
    ...
    def test_ocr_config_has_pipeline_contract(self):
        config = (ROOT / "configs/ocr.yaml").read_text(encoding="utf-8")
        for needle in ["seed:", "model:", "training:", "data:", "preprocessing:", "logging:"]:
